...
output: 
  html_document:
    ...
    toc_float: yes
params:
  csv_input_dir: 'csv/release_1.0/mbcdi_non'
...
This document imports an form of non-MB-CDI questions given age group, and language group, and creates a new file in a new directory with the idnetifers removed. To do this, we run a `remove_identifiers()` function that deletes those columns with names, addresses, dates, email addresses, and phone numbers before saving the file.
