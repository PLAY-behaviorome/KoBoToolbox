...
play_orig <- play_merge

play_merge <- play_merge %>%
  dplyr::distinct(.)
```

## Unique vs. duplicated sessions

There are $n=$ `r dim(play_merge)[1]` unique sessions in the data file. There were $n=$ `r dim(play_orig)[1]-dim(play_merge)[1]` duplicate sessions.
