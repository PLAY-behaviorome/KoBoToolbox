...
There have been `r dim(home_last_month_df)[1]` home visits since `r month_ago`.
...
There have been `r dim(home_last_3_month_df)[1]` home visits since `r three_mos_ago`.
...
There have been `r dim(home_last_6_month_df)[1]` home visits since `r six_mos_ago`.
