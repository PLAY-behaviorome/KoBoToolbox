...
```{r mcdi-12-english, eval=FALSE}
eng_12_long <- eng_12 |>
  tidyr::pivot_longer(cols = !(play_id | site_id | participant_ID),
                        names_to = "word",
...
```{r mcdi-24-eng-word-cloud, eval=FALSE}
mcdi_viz_wordcloud(word_ct, n_participants = dim(eng_24)[1], quantile = .60)
```

```{r mcdi-24-eng-rare-words-cloud, eval=FALSE}
