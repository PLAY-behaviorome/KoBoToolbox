...
# )
# 
# # Also cumbersome, but it shows what's happening
# home_visit_labor <- home_visit_labor |>
#   dplyr::select(-instruction_dishes) |>
#   # laundry
#   dplyr::mutate(laundry_self = factor(laundry_self, 
#                                       levels = div_labor_levels, 
#                                       labels = div_labor_lbls)) |>
#   dplyr::mutate(
#     laundry_partner = factor(laundry_partner, 
#                              levels = div_labor_levels, 
#                              labels = div_labor_lbls)
#   ) |>
#   dplyr::mutate(
#     laundry_otherperson = factor(laundry_otherperson, 
#                                  levels = div_labor_levels, 
#                                  labels = div_labor_lbls)
#   ) |>
#   # cleaning
#   dplyr::mutate(cleaning_self = factor(cleaning_self, 
#                                        levels = div_labor_levels, 
#                                        labels = div_labor_lbls)) |>
#   dplyr::mutate(
#     cleaning_partner = factor(cleaning_partner, 
#                               levels = div_labor_levels, 
#                               labels = div_labor_lbls)
#   ) |>
#   dplyr::mutate(
#     cleaning_otherperson = factor(cleaning_otherperson, 
#                                   levels = div_labor_levels, 
#                                   labels = div_labor_lbls)
#   ) |>
#   # cooking
#   dplyr::mutate(cooking_self = factor(cooking_self, 
#                                       levels = div_labor_levels, 
#                                       labels = div_labor_lbls)) |>
#   dplyr::mutate(
#     cooking_partner = factor(cooking_partner, 
#                              levels = div_labor_levels, 
#                              labels = div_labor_lbls)
#   ) |>
#   dplyr::mutate(
#     cooking_otherperson = factor(cooking_otherperson, 
#                                  levels = div_labor_levels, 
#                                  labels = div_labor_lbls)
#   ) |>
#   # feeding
#   dplyr::mutate(feeding_self = factor(feeding_self, 
#                                       levels = div_labor_levels, 
#                                       labels = div_labor_lbls)) |>
#   dplyr::mutate(
#     feeding_partner = factor(feeding_partner, 
#                              levels = div_labor_levels, 
#                              labels = div_labor_lbls)
#   ) |>
#   dplyr::mutate(
#     feeding_otherperson = factor(feeding_otherperson, 
#                                  levels = div_labor_levels, 
#                                  labels = div_labor_lbls)
#   ) |>
#   # dropppick
#   dplyr::mutate(droppick_self = factor(droppick_self, 
#                                        levels = div_labor_levels, 
#                                        labels = div_labor_lbls)) |>
#   dplyr::mutate(
#     droppick_partner = factor(droppick_partner, 
#                               levels = div_labor_levels, 
#                               labels = div_labor_lbls)
#   ) |>
#   dplyr::mutate(
...
#   ) |>
#   # bed
#   dplyr::mutate(bed_self = factor(bed_self, 
#                                   levels = div_labor_levels, 
#                                   labels = div_labor_lbls)) |>
#   dplyr::mutate(bed_partner = factor(bed_partner, 
#                                      levels = div_labor_levels, 
#                                      labels = div_labor_lbls)) |>
#   dplyr::mutate(
#     bed_otherperson = factor(bed_otherperson, 
#                              levels = div_labor_levels, 
#                              labels = div_labor_lbls)
#   ) |>
#   # disciplining
#   dplyr::mutate(
#     disciplining_self = factor(disciplining_self, 
#                                levels = div_labor_levels, 
#                                labels = div_labor_lbls)
#   ) |>
#   dplyr::mutate(
#     disciplining_partner = factor(disciplining_partner, 
#                                   levels = div_labor_levels, 
#                                   labels = div_labor_lbls)
#   ) |>
#   dplyr::mutate(
