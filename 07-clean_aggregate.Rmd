...
```{r}
dd <- read_csv("data_dict/release_1.0_non_mbcdi_data_dictionary.csv", show_col_types = FALSE)
```
...
dd_clean <- dd_tagged %>%
  dplyr::select(., question, question_group, short_name, long_name, shared, omitted_admin_related, omitted_identifying)

write_csv(dd_clean, 'data_dict/release_1.0_non_mbcdi_data_dictionary_clean.csv')
```
