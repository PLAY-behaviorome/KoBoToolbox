...
eng_12_363431 <-
  readr::read_csv(
    file.path(
      ...
      'data/csv/release_1.0/identifiers_removed/363431_non_mbcdi_12_english.csv'
    ),
...
eng_12_740625 <-
  readr::read_csv(
    file.path(
      params$project_root_dir,
      'data/csv/release_1.0/identifiers_removed/740625_non_mbcdi_12_english.csv'
    ),
    show_col_types = FALSE
  )
...
eng_18_363349 <-
  readr::read_csv(
    file.path(
      params$project_root_dir,
      'data/csv/release_1.0/identifiers_removed/363349_non_mbcdi_18_english.csv'
    ),
    show_col_types = FALSE
  )
...
eng_18_740628 <-
  readr::read_csv(
    file.path(
      params$project_root_dir,
      'data/csv/release_1.0/identifiers_removed/740628_non_mbcdi_18_english.csv'
    ),
    show_col_types = FALSE
  )
...
```{r}
trim_this_one <-
  (1:length(eng_12_363431_names))[eng_12_363431_names == '_version_']
...
eng_24_363381 <-
  readr::read_csv(
    file.path(
      params$project_root_dir,
      'data/csv/release_1.0/identifiers_removed/363381_non_mbcdi_24_english.csv'
    ),
    show_col_types = FALSE
  )
...
eng_24_740629 <-
  readr::read_csv(
    file.path(
      params$project_root_dir,
      'data/csv/release_1.0/identifiers_removed/740629_non_mbcdi_24_english.csv'
    ),
    show_col_types = FALSE
  )
...
readr::write_csv(
  ...
  file.path(
    ...
    '363431_non_mbcdi_12_english.csv'
  )
)
```
