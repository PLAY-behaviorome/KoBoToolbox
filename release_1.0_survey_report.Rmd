...
```{r}
l_nervous <- likert::likert(as.data.frame(play_phq$phq4_nervous))
plot(l_nervous)
```
...
```{r}
l_worrying <- likert::likert(as.data.frame(play_phq$phq4_worrying))
plot(l_worrying)
```
...
```{r}
l_littleinterest <- likert::likert(as.data.frame(play_phq$phq4_littleinterest))
...
```{r}
l_down <- likert::likert(as.data.frame(play_phq$phq4_down))
plot(l_down)
```
